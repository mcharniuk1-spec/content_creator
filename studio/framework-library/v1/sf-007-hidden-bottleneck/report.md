# SF-007 — Hidden Bottleneck

Truth state: `ORIGINAL_LOCAL_PREVISUALIZATION / EXTERNAL_PROVIDER_NOT_RUN / OWNER_REVIEW_PENDING`

## Purpose

Help viewers locate a workflow bottleneck This is a 4-second reusable hook/intro/B-roll insert, not a final video and not a performance claim.

## Signal provenance

- Export: `SIGEXP-SF-007`
- Sources: `SRC-WEB-004`
...
|---|---|---|---|---|---|
| 0–1s | question | picture_in_picture | demonstrate_process | IS THIS YOU? | `frames/SF-007-F01.svg` |
| 1–2s | symptom | picture_in_picture | demonstrate_process | THE SYMPTOM | `frames/SF-007-F02.svg` |
| 2–3s | diagnosis | picture_in_picture | demonstrate_process | DIAGNOSIS | `frames/SF-007-F03.svg` |
| 3–4s | answer frame | picture_in_picture | demonstrate_process | ANSWER | `frames/SF-007-F04.svg` |
