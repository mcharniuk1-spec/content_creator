# SF-046 — Annotation Peel

Truth state: `ORIGINAL_LOCAL_PREVISUALIZATION / EXTERNAL_PROVIDER_NOT_RUN / OWNER_REVIEW_PENDING`

## Purpose

Expose meaning one annotation at a time This is a 7-second reusable hook/intro/B-roll insert, not a final video and not a performance claim.

## Signal provenance

- Export: `SIGEXP-SF-046`
- Sources: `SRC-WEB-003`
...
|---|---|---|---|---|---|
| 0–1s | claim | full | attention_reset | THE CLAIM | `frames/SF-046-F01.svg` |
| 1–2s | hide/reveal | voice_over | attention_reset | REVEAL | `frames/SF-046-F02.svg` |
| 2–3s | proof close-up | voice_over | attention_reset | PROOF | `frames/SF-046-F03.svg` |
| 3–4s | trace | voice_over | attention_reset | TRACE | `frames/SF-046-F04.svg` |
| 4–5s | limitation | voice_over | attention_reset | LIMIT | `frames/SF-046-F05.svg` |
| 5–6s | bridge detail | voice_over | attention_reset | BRIDGE | `frames/SF-046-F06.svg` |
| 6–7s | verdict | return_cut | attention_reset | VERDICT | `frames/SF-046-F07.svg` |
