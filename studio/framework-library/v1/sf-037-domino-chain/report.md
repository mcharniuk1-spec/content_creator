...
Demonstrate dependency and propagation This is a 4-second reusable hook/intro/B-roll insert, not a final video and not a performance claim.

## Signal provenance

- Export: `SIGEXP-SF-037`
- Sources: `SRC-WEB-008`
- Evidence: `EVID-WEB-009`
...
|---|---|---|---|---|---|
| 0–1s | object action | full | establish_context | WATCH | `frames/SF-037-F01.svg` |
| 1–2s | macro detail | voice_over | establish_context | DETAIL | `frames/SF-037-F02.svg` |
| 2–3s | system analogy | voice_over | establish_context | SYSTEM | `frames/SF-037-F03.svg` |
| 3–4s | object resolves | return_cut | establish_context | RESOLVE | `frames/SF-037-F04.svg` |
