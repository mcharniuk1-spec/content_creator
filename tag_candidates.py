...
экономика внедрения. Не берём общее AI-образование и новости, «заработок на AI»,
...
NEAR = {
    'harpercarrollai': 'объясняет, как устроен AI, — образование, не процесс',
    'aasifcodes':      'обучение data и AI',
    'drcintas':        'профессор, образовательный контент',
    'soojintech':      'знакомство с AI для широкой аудитории',
    'yleintech':       'AI и тех вообще',
    'sanji.chien':     'обзоры и разборы инструментов без рабочего угла',
    'hasantoxr':       'AI-образование',
    'aidisruptor':     'ежедневные AI-новости',
    'myrasayed_':      'продуктовый опыт, но контент про эру AI вообще',
    'alex.snippet':    'программирование вообще',
    'growthforbreakfast': 'разборы брендов без AI',
    'chriswinfield':   'библиотека промптов, не процесс',
