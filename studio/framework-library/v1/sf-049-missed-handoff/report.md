# SF-049 — Missed Handoff

Truth state: `ORIGINAL_LOCAL_PREVISUALIZATION / EXTERNAL_PROVIDER_NOT_RUN / OWNER_REVIEW_PENDING`

## Purpose

Enter at the moment context disappears This is a 4-second reusable hook/intro/B-roll insert, not a final video and not a performance claim.

## Signal provenance

- Export: `SIGEXP-SF-049`
- Sources: `SRC-WEB-001`
...
|---|---|---|---|---|---|
| 0–1s | scene in progress | full | contrast | IN PROGRESS | `frames/SF-049-F01.svg` |
| 1–2s | stakes | voice_over | contrast | STAKES | `frames/SF-049-F02.svg` |
| 2–3s | action | voice_over | contrast | ACT | `frames/SF-049-F03.svg` |
| 3–4s | lesson | return_cut | contrast | LESSON | `frames/SF-049-F04.svg` |

## Production prompt

Create a vertical 9:16 4-second clean-room insert titled “Missed Handoff.” Use one meaningful visual state per second. Hook mechanism: `story_in_progress`. Viewer job: `learn_mechanism`. Visual grammar: `object_macro`. B-roll function: `contrast`. Proof form: `observed_artifact`. Keep all captions, labels, UI-like elements, and proof callouts as editable deterministic overlays. Maintain an 8% horizontal and 10% vertical planning inset, then verify the actual platform UI safe zone at production. Use only original or licensed footage and audio. Do not copy creator wording, source frames, layouts, music, gestures, identity, branded UI, or distinctive sequence. External image/video/audio provider execution remains NOT RUN.
