# SF-033 — Five System Layers

Truth state: `ORIGINAL_LOCAL_PREVISUALIZATION / EXTERNAL_PROVIDER_NOT_RUN / OWNER_REVIEW_PENDING`

## Purpose

Orient viewers inside a system This is a 6-second reusable hook/intro/B-roll insert, not a final video and not a performance claim.

## Signal provenance

- Export: `SIGEXP-SF-033`
- Sources: `SRC-WEB-005`
...
|---|---|---|---|---|---|
| 0–1s | number promise | absent | establish_context | 3 THINGS | `frames/SF-033-F01.svg` |
| 1–2s | item one | absent | establish_context | 01 | `frames/SF-033-F02.svg` |
| 2–3s | item two | absent | establish_context | 02 | `frames/SF-033-F03.svg` |
| 3–4s | item three | absent | establish_context | 03 | `frames/SF-033-F04.svg` |
| 4–5s | pattern | absent | establish_context | THE PATTERN | `frames/SF-033-F05.svg` |
| 5–6s | save exit | absent | establish_context | SAVE | `frames/SF-033-F06.svg` |
