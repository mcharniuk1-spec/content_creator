# SF-017 — AI Is Not Autonomy

Truth state: `ORIGINAL_LOCAL_PREVISUALIZATION / EXTERNAL_PROVIDER_NOT_RUN / OWNER_REVIEW_PENDING`

## Purpose

Correct an autonomy assumption This is a 8-second reusable hook/intro/B-roll insert, not a final video and not a performance claim.

## Signal provenance

- Export: `SIGEXP-SF-017`
- Sources: `SRC-WEB-002`
...
|---|---|---|---|---|---|
| 0–1s | contradiction | voice_over | demonstrate_process | THE OPPOSITE | `frames/SF-017-F01.svg` |
| 1–2s | expected model | voice_over | demonstrate_process | YOU EXPECT | `frames/SF-017-F02.svg` |
| 2–3s | break | voice_over | demonstrate_process | BUT | `frames/SF-017-F03.svg` |
| 3–4s | explanation | voice_over | demonstrate_process | HERE'S WHY | `frames/SF-017-F04.svg` |
| 4–5s | bounded rule | voice_over | demonstrate_process | THE RULE | `frames/SF-017-F05.svg` |
| 5–6s | bridge detail | voice_over | demonstrate_process | BRIDGE | `frames/SF-017-F06.svg` |
| 6–7s | proof hold | voice_over | demonstrate_process | HOLD | `frames/SF-017-F07.svg` |
| 7–8s | reframe | return_cut | demonstrate_process | REFRAME | `frames/SF-017-F08.svg` |
