# SF-053 — One-Minute Audit

Truth state: `ORIGINAL_LOCAL_PREVISUALIZATION / EXTERNAL_PROVIDER_NOT_RUN / OWNER_REVIEW_PENDING`

## Purpose

Compress an audit into causal beats This is a 8-second reusable hook/intro/B-roll insert, not a final video and not a performance claim.

## Signal provenance

- Export: `SIGEXP-SF-053`
- Sources: `SRC-WEB-001`
...
|---|---|---|---|---|---|
| 0–1s | scene in progress | voice_over | demonstrate_process | IN PROGRESS | `frames/SF-053-F01.svg` |
| 1–2s | stakes | voice_over | demonstrate_process | STAKES | `frames/SF-053-F02.svg` |
| 2–3s | decision | voice_over | demonstrate_process | DECIDE | `frames/SF-053-F03.svg` |
| 3–4s | action | voice_over | demonstrate_process | ACT | `frames/SF-053-F04.svg` |
| 4–5s | result | voice_over | demonstrate_process | RESULT | `frames/SF-053-F05.svg` |
| 5–6s | bridge detail | voice_over | demonstrate_process | BRIDGE | `frames/SF-053-F06.svg` |
| 6–7s | proof hold | voice_over | demonstrate_process | HOLD | `frames/SF-053-F07.svg` |
| 7–8s | lesson | return_cut | demonstrate_process | LESSON | `frames/SF-053-F08.svg` |

## Production prompt

Create a vertical 9:16 8-second clean-room insert titled “One-Minute Audit.” Use one meaningful visual state per second. Hook mechanism: `story_in_progress`. Viewer job: `identify_problem`. Visual grammar: `kinetic_type`. B-roll function: `demonstrate_process`. Proof form: `constraint`. Keep all captions, labels, UI-like elements, and proof callouts as editable deterministic overlays. Maintain an 8% horizontal and 10% vertical planning inset, then verify the actual platform UI safe zone at production. Use only original or licensed footage and audio. Do not copy creator wording, source frames, layouts, music, gestures, identity, branded UI, or distinctive sequence. External image/video/audio provider execution remains NOT RUN.
