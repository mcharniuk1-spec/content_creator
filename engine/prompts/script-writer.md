...
13. Audience language (Misha's decision, 13 Sep 2026; evidence `reports/audience/07-reddit-pass.md`, 101
    real threads; personas `docs/AUDIENCE_PERSONAS_2026-09-12.md`). Every card names its persona (Rick / Emma / Anna,
    `personas/*.json`) and the interest line it answers, rephrased as that person would say it. Rules: (a) name the job, not the technology — "the same 20 questions on WhatsApp",
    ...
    say so on camera when the card touches quotes; (h) a comment-keyword CTA is optional; when used, its artefact
