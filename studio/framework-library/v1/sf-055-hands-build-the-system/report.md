# SF-055 — Hands Build the System

Truth state: `ORIGINAL_LOCAL_PREVISUALIZATION / EXTERNAL_PROVIDER_NOT_RUN / OWNER_REVIEW_PENDING`

## Purpose

Cover narration with concrete assembly This is a 4-second reusable hook/intro/B-roll insert, not a final video and not a performance claim.

## Signal provenance

- Export: `SIGEXP-SF-055`
- Sources: `SRC-WEB-008`
...
|---|---|---|---|---|---|
| 0–1s | establish | picture_in_picture | establish_context | CONTEXT | `frames/SF-055-F01.svg` |
| 1–2s | action one | picture_in_picture | establish_context | STEP 1 | `frames/SF-055-F02.svg` |
| 2–3s | detail | picture_in_picture | establish_context | DETAIL | `frames/SF-055-F03.svg` |
| 3–4s | A-roll return | picture_in_picture | establish_context | RETURN | `frames/SF-055-F04.svg` |

## Production prompt

Create a vertical 9:16 4-second clean-room insert titled “Hands Build the System.” Use one meaningful visual state per second. Hook mechanism: `direct_promise`. Viewer job: `compare_options`. Visual grammar: `kinetic_type`. B-roll function: `establish_context`. Proof form: `process_trace`. Keep all captions, labels, UI-like elements, and proof callouts as editable deterministic overlays. Maintain an 8% horizontal and 10% vertical planning inset, then verify the actual platform UI safe zone at production. Use only original or licensed footage and audio. Do not copy creator wording, source frames, layouts, music, gestures, identity, branded UI, or distinctive sequence. External image/video/audio provider execution remains NOT RUN.
