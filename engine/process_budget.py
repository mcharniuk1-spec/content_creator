...
Ported verbatim from `origin/Latest:m2_orchestrator/process_budget.py` (engine/SPEC.md
§0.2). Pure stdlib — no adaptation needed beyond this docstring and module location.
"""
import os
import selectors
import shutil
